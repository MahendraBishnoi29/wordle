...
import { boardwordle, generateWords } from "./components/Words/Word.jsx";
...
function App() {
  ...
  const [currentAttempt, setCurrAttempt] = useState({
    attempt: 0,
    letterPoss: 0,
  });
  ...
  const onSelectLetter = (keyVal) => {
    ...
    const currentRow = newBoard[currentAttempt?.attempt];
    if (currentRow) {
      currentRow[currentAttempt.letterPoss] = keyVal;
      setBoard(newBoard);
      setCurrAttempt({
